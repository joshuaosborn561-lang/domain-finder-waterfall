...
- resolve_domain(source_table, where, client_tag, max_tier, min_tier, skip_tiers, concurrency, approve_cost_usd, estimate_only)
- get_job_status / cancel_job / list_jobs (in tier: processed / rows_done / requests_made / errored / last_progress_at)
